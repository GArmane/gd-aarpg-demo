...
##
## Returns newly created player character, overwriting previous if already present.
...
## Unparent current player character.
##
## Forcefully unparent current player character from scene tree.
